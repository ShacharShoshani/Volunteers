 ...
 * Use the [OrganizationsListFragment.newInstance] factory method to
...
class OrganizationsListFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment OrganizationsListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OrganizationsListFragment().apply {
